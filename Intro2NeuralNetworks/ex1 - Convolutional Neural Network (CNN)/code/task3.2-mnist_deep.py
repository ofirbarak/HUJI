...
def deepnn(x):
  ...
  """
    ...
    with tf.name_scope('conv2'):
        W_conv2 = weight_variable([5, 5, 16, 26])
        b_conv2 = bias_variable([26])
    ...
    with tf.name_scope('fc1'):
        W_fc1 = weight_variable([7 * 7 * 26, 1024])
        b_fc1 = bias_variable([1024])

        h_pool2_flat = tf.reshape(h_pool2, [-1, 7 * 7 * 26])
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        plt.show()
        print("The final test accuracy is: ", test_accuracy.append(calc_test_accuracy(accuracy, mnist, x, y_, keep_prob)))
...
"""
The final test accuracy is:  0.9557999986410141
Total time is:  48.955692768096924
"""