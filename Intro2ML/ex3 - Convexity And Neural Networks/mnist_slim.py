...
#                      weights_regularizer=slim.l2_regularizer(0.0005)):
            ...
            #net = slim.max_pool2d(net, [4, 4], 2, scope='pool1')
            #net = slim.conv2d(net, 64, [5, 5], scope='conv2')
            #net = slim.max_pool2d(net, [4, 4], 2, scope='pool2')
...
#    train_step = tf.train.GradientDescentOptimizer(learning_rate=0.001).minimize(compute_loss)
#    train_step = tf.train.AdamOptimizer(learning_rate=0.1).minimize(compute_loss)
...
#        batch_size = 3
        ...
        for i in range(1, num_iters):
            ...
            tgraph.append(np.mean(accuracies))
            if i % 20 == 0:
        ...
        print("Training the model took ", time.time()-stime)
        print("batch size ", batch_size)
        plt.plot(titers, tgraph, label="train_set")
        plt.plot(fiters, fgraph, label="test_set")
        plt.show()
